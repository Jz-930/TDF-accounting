...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-primary-dark pt-20 pb-40 lg:pb-48">
      ...
      <div className="absolute inset-0 bg-[url('/images/Contact-bg.jpg')] opacity-5 mix-blend-overlay" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start pr-0 lg:pr-12 relative z-20">
            ...
            <p className="text-xl text-white/70 mb-12 max-w-xl leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
              <Button size="lg" variant="gradient" className="text-lg px-8 h-14 shadow-[0_0_40px_rgba(90,159,201,0.4)] hover:shadow-[0_0_60px_rgba(90,159,201,0.6)]" asChild>
          ...
          <div className="lg:col-span-5 relative mt-8 lg:mt-0 w-full max-w-[420px] mx-auto">
            ...
            <div className="relative aspect-[3/4] w-full rounded-[2.5rem] overflow-hidden border border-white/20 shadow-[0_20px_60px_rgba(0,0,0,0.5)] group">
              ...
              <div className="absolute bottom-6 right-6 glass p-4 rounded-xl flex items-center gap-3 border border-white/20">
                <Image src="/images/weblogo2.png" alt="TDF Icon" width={90} height={24} className="w-auto h-5 object-contain" />
              </div>
